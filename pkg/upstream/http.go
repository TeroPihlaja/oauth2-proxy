...
func newHTTPUpstreamProxy(upstream options.Upstream, u *url.URL, auth hmacauth.HmacAuth, errorHandler ProxyErrorHandler) http.Handler {
...
// receive the original host header from the user request.
